"""
formulations for kidney exchange, including PICEF
"""
...
def start():
    ...
    parser.add_argument("cycle_cap", type=int, default=6,
            help="The maximum permitted cycle length")
    parser.add_argument("chain_cap", type=int, default=6,
            help="The maximum permitted number of edges in a chain")
    parser.add_argument("formulation", default='picef',
    ...
    input_lines = [line for line in fileinput.input("64examples.input")]      #input filename
